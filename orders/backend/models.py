...
class User(AbstractUser):
    ...
    is_active = models.BooleanField(
        ...
        default=False,
        help_text=_(
            'Desigantes whether this user should be treated as active. '
...
class Shop(models.Model):
    ...
    user = models.OneToOneField(User, verbose_name='Ползователь',
...
class Order(models.Model):
    ...
    state = models.CharField(max_length=15, verbose_name='Статус', choices=STATUS_CHOICES)
